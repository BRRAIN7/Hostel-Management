...
//        }
        ...
        if (!StudentValidation.isValidPassword(S.getStudentPass())) {
            JOptionPane.showMessageDialog(null, "Invalid Password. Password must be at least 8 characters long and contain at least one digit, one uppercase letter, one lowercase letter, and one special character.");
            return;
        }
