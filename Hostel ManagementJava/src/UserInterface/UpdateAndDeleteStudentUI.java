...
public class UpdateAndDeleteStudentUI extends JFrame {
    private Student currentStudent = null;
    private JTextField nameField, genderField, contactField, addressField, passwordField;
    ...
    public UpdateAndDeleteStudentUI() {
        ...
        searchField.setBounds(330, 50, 150, 25);
        panel.add(searchField);

        JButton searchButton = new JButton("Search");
        searchButton.setBounds(500, 50, 100, 25);
        ...
        tableScroll.setBounds(100, 90, 1000, 100);
        ...
        nameField = createField(panel, "Name", labelX, fieldX, y); y += gap;
        genderField = createField(panel, "Gender", labelX, fieldX, y); y += gap;
        contactField = createField(panel, "Contact", labelX, fieldX, y); y += gap;
        addressField = createField(panel, "Address", labelX, fieldX, y); y += gap;
        passwordField = createField(panel, "Password", labelX, fieldX, y); y += gap;
        ...
        resetButton.setBounds(450, 270, 150, 25);
    ...
    private void handleSearch() {
        ...
        if (query.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter a student name or ID to search.", "Input Error", JOptionPane.WARNING_MESSAGE);
            return;
        }
